    ...
    <div class="row">
      <div class="col-lg-7 mb-4 mb-lg-0">
        <form action="{{route('store')}}" method="POST">
          ...
          <input type="email" class="form-control mb-3" id="mail" name="mail" placeholder="Correo" required>
          <input type="text" class="form-control mb-3" id="subject" name="subject" placeholder="Asunto" required>
          <textarea  id="message" class="form-control mb-3"name="message" placeholder="Mensaje" required></textarea>
      ...
      <div class="col-lg-5">
        ...
        <a href="tel:+51922753771" class="text-color h5 d-block">+51 922 753 771</a>
        <a href="mailto:yourmail@email.com" class="mb-5 text-color h5 d-block">melissa.sanchez@competitividadccd.com</a>
        
        <p>Avenida Felipe Pardo y Aliaga<br>Nº 699<br>SAN ISIDRO, LIMA (Lima)</p>
        <div class="card">
          <div class="card-body">
