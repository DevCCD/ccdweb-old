    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-Nosotros">
          <li class="list-inline-item"><a class="h2 text-primary font-secondary" href="{{route('servicios')}}">{{__('paginaprincipal.Nuestros Servicios')}}</a></li>
          <li class="list-inline-item text-white h3 font-secondary nasted">{{__('inicio.Desarrollo y Competividad')}}</li>
        </ul>      
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row align-items-center ">
      <div class="col-12 order-1 ">
        <h2  data-aos="fade-right" data-aos-duration="2000">{{__('inicio.Desarrollo y Competividad')}}</h2>
      </div>
    ...
    <div class="row">
      <div class="col-12 mb-4">
        <h3  data-aos="fade-right" data-aos-duration="2000">{{__('competitividad.AS')}}</h3>
        <p data-aos="fade-right" data-aos-duration="2000">{{__('competitividad.AC')}}</p>
      </div>
